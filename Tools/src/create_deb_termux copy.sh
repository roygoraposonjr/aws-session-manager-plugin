...
cp ${GO_SPACE}/packaging/linux_plugin/session-manager-plugin.conf ${GO_SPACE}/bin/termux_plugin/linux/${TERMUX_PREFIX}/etc/init/
cp ${GO_SPACE}/packaging/linux_plugin/session-manager-plugin.service ${GO_SPACE}/bin/termux_plugin/linux/${TERMUX_PREFIX}/etc/systemd/system/
